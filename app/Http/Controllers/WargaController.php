...
class WargaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            'umur.numeric' => 'umur warga harus harus berupa angka',
            'status.required' => 'status pernikahan harus diisi',
            'foto.mimes' => 'file anda upload bukan gambar',
            'foto.max' => 'ukuran gambar tidak boleh melebihi 1 MB',
        ]
